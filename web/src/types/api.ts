...
export type McapDeltaRow = {
  ...
  end_pe: number | null;
  delta_pe: number | null;
  delta_pe_pct: number | null;
  start_pb: number | null;
  end_pb: number | null;
  delta_pb: number | null;
  delta_pb_pct: number | null;
  start_ps: number | null;
  end_ps: number | null;
  delta_ps: number | null;
  delta_ps_pct: number | null;
...
export type McapDeltaTotals = {
  ...
  start_mcap: number | null;
  end_mcap: number | null;
  avg_delta_pe: number | null;
  avg_delta_pe_pct: number | null;
  avg_delta_pb: number | null;
  avg_delta_pb_pct: number | null;
  avg_delta_ps: number | null;
  avg_delta_ps_pct: number | null;
  included: number;
  failed: number;
};
